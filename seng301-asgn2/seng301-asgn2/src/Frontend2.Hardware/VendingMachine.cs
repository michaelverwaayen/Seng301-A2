    ...
    */
    public class VendingMachine {
        ...
        */
        ...
        public VendingMachine(List<int> coinKinds1, int selectionButtonCount)
        {
            this.coinKinds1 = coinKinds1;
            this.selectionButtonCount = selectionButtonCount;
        }

        public VendingMachine(List<int> coinKinds1, int selectionButtonCount, int coinRackCapacity, int popRackCapcity, int receptacleCapacity) : this(coinKinds1, selectionButtonCount)
        {
        ...
        */
        ...
        internal void ConfigureVendingMachine(List<string> popNames, List<int> popCosts)
        {
            throw new NotImplementedException();
        }

        internal void LoadCoins(int coinKindIndex, List<Coin> coins)
        {
            throw new NotImplementedException();
        }

        internal void LoadPops(int popKindIndex, List<PopCan> pops)
        {
            throw new NotImplementedException();
        }

        internal void PressButton(int value)
        {
            throw new NotImplementedException();
        }

        internal VendingMachineStoredContents UnloadVendingMachine()
        {
            throw new NotImplementedException();
        }
    }
